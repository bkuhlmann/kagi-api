...
RSpec.describe Kagi::API::Endpoints::Enrich::Web do
      ...
      it "answers record" do
        ...
        expect(result).to be_failure(
          Kagi::API::Models::Error[
            meta: Kagi::API::Models::Content::Meta[id: "abc", node: "us-west", duration: 20],
  ...
  describe "#inspect" do
    it_behaves_like "an inspectable", described_class.new
  end
end
